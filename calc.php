 ...
 <link rel="stylesheet" href="css/calccolor.css">
   <body>
      <form name="calc">
		...
		<td><input type="button" name="enter" value="=" try: onclick="calc.display.value = eval(calc.display.value)" except SyntaxError: onclick="calc.display.calue = 'Invalid Value'"></td>
